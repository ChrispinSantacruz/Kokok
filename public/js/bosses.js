...
export class TrumpBoss {
  constructor(canvas) {
    ...
    this.velocity = new Vector2(isResponsive ? 1.125 : 3, 0) // Aumentado de 0.9 a 1.125 en responsive (+25%)
    this.health = 10
    this.maxHealth = 10
    this.active = true
    this.shootTimer = 0
    ...
    this.baseSpeed = isResponsive ? 1.125 : 3  // Aumentado de 0.9 a 1.125 en responsive (+25%)
  ...
  update() {
    ...
    if (!this.isRandomMovement) {
      ...
      if (this.randomMovementTimer <= 0) {
        ...
        const isResponsive = window.innerWidth < 1025
        const baseMovementSpeed = isResponsive ? 1.125 : 9  // Aumentado de 0.9 a 1.125 en responsive (+25%)
  ...
  takeDamage(damage = 1) {
    ...
    const isResponsive = window.innerWidth < 1025
    const maxSpeed = isResponsive ? 4.6875 : 12  // Aumentado de 3.75 a 4.6875 en responsive (+25%)
